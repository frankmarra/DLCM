    ...
    >
      <div className="faq-section stack" id="faq-section">
        ...
        <p>
          ...
          Enter your email and choose a password. This is how you will log in to
          DLCM in the future.
        </p>
        <p>
        ...
        <p>
          ...
          upload two releases. A release can be anything from a single to an LP.
          You are also able to upload as many codes as you want for both of
          those releases, as well as upload the artwork for each. (Artwork must
          be less than 1MB)
        </p>
        ...
        <p>
          ...
          the previous address show a page not found error. Make sure you tell
          all of your fans before making this change.
        </p>
        ...
        <p>
          ...
          other releases and codes associated with them will be removed from our
          system. You will also no longer have any of the other perks that come
          with a pro account.
        </p>
      </div>
      <div className="tutorial-section stack" id="tutorial-section">
        ...
        <p>
          ...
          release button and enter your release information. Click create to add
          your first release.
        </p>
        ...
        <p>
          ...
          codes by uploading the bandcamp provided CSV file. When you click add,
          these codes will now be ready to be dispersed amongst your adoring
          fans. Great Job!
        </p>
